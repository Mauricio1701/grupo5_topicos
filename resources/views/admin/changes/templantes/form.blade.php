    ...
    <div id="turnoFields" class="changeFields row mb-3" style="display: none;">
        <div class="col-md-12">
    ...
    <div id="vehiculoFields" class="changeFields row mb-3" style="display: none;">
        <div class="col-md-12">
            <div class="row align-items-end">
                <div class="col-md-6">
    ...
    <div id="personalFields" class="changeFields row mb-3" style="display: none;">            
        {{-- Personal Actual --}}
        <div class="col-md-6">
